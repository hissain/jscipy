 ...
 * <p>
 * <img src=
 * "https://raw.githubusercontent.com/hissain/jscipy/main/python/figs/chebyshev/cheby2_input1.txt_light.png"
 * alt="Chebyshev Type II Comparison" style="width: 600px; max-width: 90%; display: block; margin: 0 auto;">
 */
public class Chebyshev2 {
    ...
    private static double[] runFilter(double[] signal, Chebyshev2Design design) {
    ...
    private static double[] runFiltFilt(double[] signal, Chebyshev2Design design) {
